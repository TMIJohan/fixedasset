...
<head>
    ...
    <title>Dashboard - Entry Supplier</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="new-supplier-proses.php">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="SUPPNAME" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Supplier Short Name</label>
                                                <input type="text" class="form-control" placeholder="" name="SUPPSHORTNAME" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                        </div>
                                    </div>
                                </div>
