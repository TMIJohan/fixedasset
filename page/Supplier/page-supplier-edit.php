<?php
    ...
    $ID = $_GET['id'];
    $query = oci_parse($conn, "SELECT SUPPCODE, SUPPNAME, SUPPSHORTNAME FROM TBLSUPPLIER WHERE SUPPCODE = '".$ID."'");
    oci_execute($query);
    ...
    <div id="main-wrapper">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="page-supplier.php">Supplier</a></li>
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="edit-supplier-proses.php">
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="SUPPCODE" autocomplete="off" value="<?php echo $row['SUPPCODE'];?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Description</label>
                                                <input type="text" class="form-control" placeholder="" name="SUPPNAME" autocomplete="off" value="<?php echo $row['SUPPNAME'];?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Short Description</label>
                                                <input type="text" class="form-control" placeholder="" name="SUPPSHORTNAME" autocomplete="off" value="<?php echo $row['SUPPSHORTNAME'];?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
