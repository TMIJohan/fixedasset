                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $q = oci_parse($conn, "SELECT SUPPCODE, SUPPNAME, SUPPSHORTNAME FROM TBLSUPPLIER");
                                                oci_execute($q);
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            <td><?php ECHO $no++;?></td>
                                                            <td><?php ECHO $r['SUPPCODE'];?></td>
                                                            <td><?php ECHO $r['SUPPNAME']?></td>
                                                            <!-- <td><?php ECHO $r['SUPPSHORTNAME']?></td> -->
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-supplier-edit.php?id=<?php echo $r['SUPPCODE']; ?>">
                                                                ...
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-supplier-delete.php?id=<?php echo $r['SUPPCODE']; ?>" class="btndelete">
