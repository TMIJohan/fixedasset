...
<head>
    ...
    <title>Dashboard - Master Department </title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="page-department.php">Department</a></li>
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <div class="toolbar mb-2" role="toolbar">
                            <div class="btn-group mb-1">
                                <a href="page-department-new.php">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $q = oci_parse($conn, "SELECT DEPTCODE, DEPTNAME FROM TBLDEPARTMENT ");
                                                oci_execute($q);
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            <td><?php ECHO $no++;?></td>
                                                            <td><?php ECHO $r['DEPTCODE'];?></td>
                                                            <td><?php ECHO $r['DEPTNAME']?></td>
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-department-edit.php?id=<?php echo $r['DEPTCODE']; ?>">
                                                                ...
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-department-delete.php?id=<?php echo $r['DEPTCODE']; ?>" class="btndelete">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>&copy; <?php echo date("Y"); ?><a href="#" target="_blank"></a></p>
            </div>
        </div>
        <!--**********************************
            Footer end
