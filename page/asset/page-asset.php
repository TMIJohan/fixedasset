...
<head>
    ...
    <title>Dashboard - Fixed Asset </title>
    <!-- Favicon icon -->
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        ...
                        ?>
                            <div class="toolbar mb-2" role="toolbar">
                                ...
                                <div class="btn-group mb-1">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter" title="Print Report"><i class="fa fa-print" aria-hidden="true"></i></button>
                                    <!-- Modal -->
                                            ...
                                            <form method="post" action="Print.php">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Report Fixed Asset</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="form-row">
                                                            <label><b><u>Fillter</u></b></label>
                                                            <span></span>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Date From</label>
                                                                <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" name="fromdate">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label>Date To</label>
                                                                <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" name="todate">
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Category</label>
                                                                <select class="default-placeholder" name="category">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select class="default-placeholder" name="location">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select class="default-placeholder" name="currency">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-secondary" name="btnprint">Print</button>
                                                    </div>
                                                </div>
                                            </form>
                                ...
                                <div class="btn-group mb-1">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter1" title="Export Asset"><i class="fa fa-upload" aria-hidden="true"></i></button>
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModalCenter1">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <form method="post" action="export-asset.php">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Export Fixed Asset</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        <button type="submit" class="btn btn-secondary" name="btnprint">Export</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="btn-group mb-1">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal" title="Import Asset" data-target="#basicModal">
                                    ...
                                    <table id="example" class="display" style="min-width: 1000px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                if ($role == "admin") {
                                                    $q = oci_parse($conn, "SELECT ASSETCODE, ASSETSHORTNAME, CATNAME, ASSETDATE
                                                        FROM TBLASSET
                                                        INNER JOIN TBLCATASSET ON TBLASSET.ASSETCAT = TBLCATASSET.CATCODE WHERE DISPOSAL = 0
                                                ...
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php ECHO $r['ASSETSHORTNAME']?></td>
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-asset-edit.php?id=<?php echo $r['ASSETCODE']; ?>">
                                                                ...
                                                                ?>
                                                                    <div class="btn-group mb-1">
                                                                        <a href="page-asset-delete.php?id=<?php echo $r['ASSETCODE']; ?>" class="btndelete">
