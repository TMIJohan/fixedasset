<?php
    ...
    $query = oci_parse($conn, "SELECT CATCODE, CATNAME FROM TBLCATASSET WHERE CATCODE = '".$ID."'");
    oci_execute($query);
...
<head>
    ...
    <title>Dashboard - Edit Category Asset</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="edit-cat-proses.php">
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Category Asset</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="CATCODE" value="<?php echo $row['CATCODE'];?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Category Name</label>
                                                <input type="text" class="form-control" placeholder="" name="CATNAME" value="<?php echo $row['CATNAME'];?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
