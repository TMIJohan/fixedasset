...
<head>
    ...
    <title>Dashboard - Entry Disposal</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="new-disposal-proses.php">
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Disposal Asset</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="DisposalCode" value="<?php echo $discode; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''" readonly>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
	                                            ...
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="" name="DisposalDate" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'">
	                                        </div>
	                                        <div class="form-group col-md-6">
	                                            <label>Year Mfg</label>
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="" name="DisposalYear" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'">
	                                        </div>
	                                    </div>
	                                    <div class="form-row">
                                            <div class="form-group col-md-6">
                                            	<label>Description</label>
                                            	<textarea class="form-control" rows="2" id="comment" name="DisposalDesc"><?php echo $row['ASSETDESC']; ?></textarea>
                                        	</div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="DisposalSerial" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Model No.</label>
                                                <input type="text" class="form-control" placeholder="" name="DisposalModel" value="<?php echo $row['ASSETMODEL']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                        	<div class="form-group col-md-12">
                                                <label>Reason for Disposal</label>
                                                <textarea class="form-control" rows="2" id="comment" name="DisposalReason"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
