...
include '../../conn.php';
    ...
    if ($result){
    	$queryasset = oci_parse($conn, "UPDATE TBLASSET SET DISPOSAL = 0 WHERE ASSETCODE = '".$ASSETCODE."'");
        echo "<script type='text/javascript'>document.location='page-disposal.php'</script>";
    } else {
