...
<head>
    ...
    <title>Dashboard - Master Currency </title>
    <!-- Favicon icon -->
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $q = oci_parse($conn, "SELECT CURR_CODE, CURR_NAME, CURR_SHORT_NAME, CURR_UNIT_NAME FROM FM_CURRENCY");
                                                oci_execute($q);
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            <td><?php ECHO $no++;?></td>
                                                            <td><?php ECHO $r['CURR_CODE'];?></td>
                                                            <td><?php ECHO $r['CURR_NAME']?></td>
                                                            <td><?php ECHO $r['CURR_SHORT_NAME']?></td>
                                                            <td><?php ECHO $r['CURR_UNIT_NAME']?></td>
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-currency-edit.php?id=<?php echo $r['CURR_CODE']; ?>">
                                                                ...
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-currency-delete.php?id=<?php echo $r['CURR_CODE']; ?>" class="btndelete">
