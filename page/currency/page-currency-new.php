                                    ...
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="curr_code">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>ISO Code</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_iso_code">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Description</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Short Description</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_short_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Unit Description</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_unit_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Short Unit Description</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_short_unit_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Format Mask (Example : 999,999,99,99)</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_fmt_mask">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Number Of Decimals</label>
                                                <input type="text" class="form-control" placeholder="" name="curr_decimal">
                                            </div>
                                        </div>
                                    </div>
                                </div>
