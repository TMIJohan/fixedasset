<?php
    ...
    $ID = $_GET['id'];
    $transcode = $_GET['transferno'];

    $query = oci_parse($conn, "SELECT ASSETCODE, ASSETDESC, ASSETMODEL, ASSETLOC 
...
<head>
    ...
    <title>Dashboard - Entry Transfer</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="new-transfer-proses.php">
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Transfer Asset</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="TransferCode" value="<?php echo $transcode; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Asset Code</label>
                                                <input type="text" class="form-control" placeholder="" name="ASSETCODE" value="<?php echo $row['ASSETCODE']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                            
                                            <div class="form-group col-md-6">
	                                            <label>Transfer Date</label>
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="" name="TransferDate" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'">
	                                        </div>
	                                        <div class="form-group col-md-6">
	                                            <label>Year Mfg</label>
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="" name="TransferYear" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'">
	                                        </div>
	                                    </div>
	                                    <div class="form-row">
	                                    	<!-- <div class="form-group col-md-6">
                                                <label>Description</label>
                                                <input type="text" class="form-control" placeholder="" name="TransferDesc" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div> -->
                                            <div class="form-group col-md-6">
                                            	<label>Description</label>
                                            	<textarea class="form-control" rows="2" id="comment" name="TransferDesc"><?php echo $row['ASSETDESC']; ?></textarea>
                                        	</div>
	                                    </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Transfer Serial No.</label>
                                                <input type="text" class="form-control" placeholder="" name="TransferSerial" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Transfer Model No.</label>
                                                <input type="text" class="form-control" placeholder="" name="TransferModel" value="<?php echo $row['ASSETMODEL']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                        ...
                                        <div class="form-row">
                                        	<div class="form-group col-md-6">
                                                ...
                                                <select class="default-placeholder" name="TransferFrom">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="default-placeholder" name="TransferTo">
                                                    <option value="-">SELECT DEP/LOC</option>
                                                    <?php
