...
<head>
    ...
    <title>Dashboard - Transfer Asset </title>
    <!-- Favicon icon -->
                            ...
                            <div class="toolbar mb-2" role="toolbar">
                                <div class="btn-group mb-1">
                                    ...
                                    <div class="modal fade" id="modaladd">
                                    	<form method="post" action="transfer-modal.php">
                                    		<div class="modal-dialog" role="document">
	                                            <div class="modal-content">
	                                                ...
	                                                <div class="modal-footer">
	                                                    ...
	                                                    <button type="submit" class="btn btn-primary" name="btntransfer">Add Transfer</button>
	                                                </div>
	                                            </div>
	                                        </div>
                                    	</form>
                                ...
                                <div class="btn-group mb-1">
                                    ...
                                    <div class="modal fade" id="modalprint">
                                        <form method="post" action="print-transer-form.php">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Print Form Transfer</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="form-group col-md-12">
                                                            <label>Choose Asset Code</label>
                                                            <select class="default-placeholder" name="TransferCode">
                                                                <option value="-">SELECT ASSET</option>
                                                                <?php
                                                                $q = oci_parse($conn, "SELECT TBLINV.INVCODE, TBLINV.ASSETCODE || ' - ' || ASSETSHORTNAME AS ASSETNAME FROM TBLASSET
                                                                    ...
                                                                    WHERE INVTYPE = 'TRANSFER' AND TBLINV.DELETED = 0
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        <button type="submit" class="btn btn-primary" name="btntransfer">Print</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <?php
                                                $no = 1;
                                                    $q = oci_parse($conn, "SELECT TBLINV.INVCODE, TBLINV.ASSETCODE, TBLINV.INVDATE 
														FROM TBLINV 
														INNER JOIN TBLASSET ON TBLINV.ASSETCODE = TBLASSET.ASSETCODE WHERE TBLINV.DELETED = 0 AND INVTYPE = 'TRANSFER' 
                                                ...
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-transfer-edit.php?id=<?php echo $r['INVCODE']; ?>">
