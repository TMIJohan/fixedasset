<?php
    ...
    $query = oci_parse($conn, "SELECT INVCODE, ASSETCODE, INVTYPE, INVDATE, INVDESC, INVSERIAL, INVMODEL, YEAR, TRANFERFROM, TRANSFERTO 
...
<head>
    ...
    <title>Dashboard - Edit Transfer</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="edit-transfer-proses.php">
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Transfer Asset</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="TransferCode" value="<?php echo $row['INVCODE']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''" readonly>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
	                                            ...
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d',strtotime($row["INVDATE"]))?>" placeholder="" name="TransferDate" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'" readonly>
	                                        </div>
	                                        <div class="form-group col-md-6">
	                                            <label>Year Mfg</label>
	                                            <input type="date" class="form-control" value="<?php echo date('Y-m-d',strtotime($row["YEAR"]))?>" placeholder="" name="TransferYear" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value='<?php echo date('Y-m-d'); ?>'">
	                                        </div>
	                                    </div>
	                                    <div class="form-row">
	                                    	<!-- <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                            	<label>Description</label>
                                            	<textarea class="form-control" rows="2" id="comment" name="TransferDesc"><?php echo $row['INVDESC']; ?></textarea>
                                        	</div>
	                                    </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Transfer Serial No.</label>
                                                <input type="text" class="form-control" placeholder="" name="TransferSerial" value="<?php echo $row['INVSERIAL']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Transfer Model No.</label>
                                                <input type="text" class="form-control" placeholder="" name="TransferModel" value="<?php echo $row['INVMODEL']; ?>" autocomplete="off" onkeyup="if ( event.keyCode == 27 ) this.value=''">
                                            </div>
