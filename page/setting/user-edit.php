<?php
    ...
    $query = oci_parse($conn, "SELECT * FROM TBLUSER WHERE USERNAME = '".$ID."'");
    oci_execute($query);
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="password-field" type="password" class="form-control" placeholder="" name="PASSWORD" autocomplete="off" value="<?php echo $row['PASSWORD'];?>">
