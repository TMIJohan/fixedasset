...
<head>
    ...
    <title>Dashboard - Master User </title>
    <!-- Favicon icon -->
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $q = oci_parse($conn, "SELECT * FROM TBLUSER ");
                                                oci_execute($q);
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="user-edit.php?id=<?php echo $r['USERNAME']; ?>">
                                                                ...
                                                                <div class="btn-group mb-1">
                                                                    <a href="user-delete.php?id=<?php echo $r['USERNAME']; ?>" class="btndelete">
