    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="user-new-proses.php">
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="password-field" type="password" class="form-control" placeholder="" name="PASSWORD" autocomplete="off">
                                                <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Role</label>
                                                <select class="default-placeholder" name="ROLE">
