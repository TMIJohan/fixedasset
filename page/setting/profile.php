<?php
    ...
    $query = oci_parse($conn, "SELECT * FROM TBLUSER WHERE USERNAME = '".$username."' AND role = '".$role."' AND DEPARTMENT = '".$department."'");
    oci_execute($query);
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="USERNAME" autocomplete="off" value="<?php echo $row['USERNAME'];?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Password</label>
                                                <input type="password" class="form-control" placeholder="" name="PASSWORD" autocomplete="off" value="<?php echo $row['PASSWORD'];?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Role</label>
                                                <select class="default-placeholder" name="ROLE" disabled>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="default-placeholder" name="DEPARTMENT">
