...
<head>
    ...
    <title>Dashboard - Entry Unit</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="new-unit-proses.php">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="uomcode">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>UOM Name</label>
                                                <input type="text" class="form-control" placeholder="" name="uomname">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Short Description</label>
                                                <input type="text" class="form-control" placeholder="" name="uomshort">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Maximum Loose</label>
                                                <input type="text" class="form-control" placeholder="" name="maxloose">
                                            </div>
                                        </div>
                                    </div>
                                </div>
