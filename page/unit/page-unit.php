...
<head>
    ...
    <title>Dashboard - Master Unit </title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="../currency/page-currency.php">Currency</a></
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Master Unit Of Measurement</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <div class="toolbar mb-2" role="toolbar">
                            <div class="btn-group mb-1">
                                <a href="page-unit-new.php">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $q = oci_parse($conn, "SELECT UOM_CODE, UOM_NAME, UOM_SHORT_NAME, UOM_MAX_LOOSE FROM OM_UOM");
                                                oci_execute($q);
                                                While ($r = oci_fetch_array($q)){
                                                    ?>
                                                        <tr>
                                                            <td><?php ECHO $no++;?></td>
                                                            <td><?php ECHO $r['UOM_CODE'];?></td>
                                                            <td><?php ECHO $r['UOM_NAME']?></td>
                                                            <td><?php ECHO $r['UOM_SHORT_NAME']?></td>
                                                            <td><?php ECHO $r['UOM_MAX_LOOSE']?></td>
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-unit-edit.php?id=<?php echo $r['UOM_CODE']; ?>">
                                                                ...
                                                                <div class="btn-group mb-1">
                                                                    <a href="page-unit-delete.php?id=<?php echo $r['UOM_CODE']; ?>" class="btndelete">
