    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="new-department-proses.php">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="deptcode" autocomplete="off">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Department Name</label>
                                                <input type="text" class="form-control" placeholder="" name="deptname" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
