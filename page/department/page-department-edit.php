<?php
    ...
    $ID = $_GET['id'];
    $q = oci_parse($conn, "SELECT * FROM TBLDEPARTMENT WHERE DEPTCODE = '".$ID."'");
    oci_execute($q);
    $r = oci_fetch_array($q);
    //
?>
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <form method="post" action="edit-department-proses.php">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="deptcode" value="<?php echo $r['DEPTCODE']; ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Department Name</label>
                                                <input type="text" class="form-control" placeholder="" name="deptname" value="<?php echo $r['DEPTNAME']; ?>" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
